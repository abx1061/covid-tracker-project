...
<span onclick="openNav()"> <img src="/images/navSIDE.png" alt="sNAVpng" width="50" height="50"> </span>
</div>
   <div id="main">
...
<!--####---- COVID CASES CONTAIENR & DATABASE PHP-->
   ...
   <div class="HOME_container_PAGE2">
    ...
    <?php
    $conn = mysqli_connect("localhost", "root", "", "summary_ukcovid_data");
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/summaryGraphs/summaryCasesGraph.php">
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/summaryGraphs/summaryDeaths.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/summaryGraphs/summaryAdmitted.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
</div>   
...
<div class="HOME_container_PAGE2">
 <div class="block"> <h3> vaccines</h3> 
 <p> As of the 19/04/2021 </p>
 <?php
    $conn = mysqli_connect("localhost", "root", "", "summary_ukcovid_data");
    $sql = "SELECT * FROM cases WHERE cases_date ='19/04/2021';";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result-> fetch_assoc()) {
            echo "NATIONAL VACCINATION COUNT: ";
            echo $row["cases_virus_tests"];
        }
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/summaryGraphs/summaryVaccines.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
