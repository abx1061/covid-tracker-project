...
<h1>Liverpool Coronavirus Cases</h1>
...
<style>
body {
    background-image: url('/images/liverpoolBCK.png');
}
</style>
...
<!--####---- COVID CASES CONTAIENR & DATABASE PHP-->
   ...
   <div class="HOME_container_PAGE2">
    ...
    <?php
    $conn = mysqli_connect("localhost", "root", "", "covid_data_liverpool");
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/liverpoolGraphs/liverpoolCASES.php">
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/liverpoolGraphs/liverpoolDEATHS.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/liverpoolGraphs/liverpoolPATIENTS.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
</div>   
