...
.logoimg5 {
  ...
  right: 5%;
    ...
    <div class ="titleNAV">
        ...
        <h1>LONDON CORONAVIRUS CASES</h1>
...
<!--####---- COVID CASES CONTAIENR & DATABASE PHP-->
   ...
   <div class="HOME_container_PAGE2">
    ...
    <?php
    $conn = mysqli_connect("localhost", "root", "", "london_covid_data");
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/londonGraphs/londonCases.php">
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/londonGraphs/LondonDeaths.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
...
<div class="HOME_container_PAGE2">
 ...
 <?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result-> fetch_assoc()) {
            echo "PATIENTS IN HOSPITAL COUNT: ";
    ...
    ?>
    <div class="iconCASES">
    <p><a href="/GraphsPHP/londonGraphs/LondonAdmitted.php">
    <img src="/images/charticonPNG.png" alt="CHART" width="50" height="50">
    </a></p>
   </div>
</div>   
